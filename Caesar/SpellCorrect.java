...
public class SpellCorrect {
	...
	public static boolean correct(String word){
        ...
        //语料库中没有该单词,则返回该单词本身
        return info.get(0).getValue()>0 ? true : false;*/        //注释掉的这一段是因为他写了个函数处理单个词错误的情况下试着加上或者修改这一个字符26次直到拼写正确
	}                                                         //我们只需要判断拼写正确与否，而不是修正错误的拼写！！！！！！！！！！！！！！！！！
	...
	* @throws
	...
	public static Map<String,Integer> train(){
		...
		try {
			is = new FileInputStream("E:/eclipse文件/Security/src/com/company/big.txt");
